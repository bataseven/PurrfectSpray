...
! function(t, e) {
    ...
    var F, M = function(t) {
        ...
        U = function(t) {
            ...
            function i(t) {
                var r;
                return e(this, i), (r = n.call(this)).writable = !1, D(f(r), t), r.opts = t, r.query = t.query, r.socket = t.socket, r
            }
            return r(i, [{
                key: "onError",
            ...
            return r(a, [{
                ...
                value: function(t) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        n || e.type === Et.BINARY_ACK ? (e.type = n ? Et.EVENT : Et.ACK, this.reconstructor = new Rt(e), 0 === e.attachments && y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)) : y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)
                    } else {
        ...
        St = function(t) {
            ...
            return r(a, [{
                ...
                value: function(t) {
                    ...
                    y(s(a.prototype), "emit", this).apply(this, t), this._pid && t.length && "string" == typeof t[t.length - 1] && (this._lastOffset = t[t.length - 1])
                }
            }, {
                key: "ack",
                value: function(t) {
    ...
    var xt = function(n) {
            ...
            return r(s, [{
                ...
                value: function(t, e) {
                    var n = this.nsps[t];
                    return n ? this._autoConnect && !n.active && n.connect() : (n = new St(this, t, e), this.nsps[t] = n), n
                }
            }, {
                key: "_destroy",
                value: function(t) {
